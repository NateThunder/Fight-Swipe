...
// Separate namespace so create-system flows don't collide with the main Fight Swipe saves.
const STORAGE_KEY = "createSystem.gameSaves"
const AUTOSAVE_KEY = "createSystem.autosave"

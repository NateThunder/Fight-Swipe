  ...
  return (
    <GestureHandlerRootView style={{ flex: 1, backgroundColor: "#0b0d12" }}>
      <View style={{ flex: 1, paddingTop: insets.top + 20, paddingHorizontal: 16, gap: 16 }}>
        ...
        <View style={{ gap: 8 }}>
          <Text style={{ color: "#f8fafc", fontSize: 26, fontWeight: "800" }}>Settings</Text>
          <Text style={{ color: "#94a3b8", fontSize: 14 }}>Configure your Fight Swipe experience.</Text>
        </View>
        ...
        >
          <Text style={{ color: "#e2e8f0", fontWeight: "700", fontSize: 16 }}>Coming soon</Text>
          <Text style={{ color: "#94a3b8", fontSize: 13, lineHeight: 20 }}>
            Settings will live here. Add preferences or account options when ready.
          </Text>
        </View>
      </View>
